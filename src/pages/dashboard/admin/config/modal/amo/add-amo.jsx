...
import { addAircraftMaintenanceOrgAsync } from "../../../../../../slices/amo/amoSlice";

function AddAmo(props) {
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title id="contained-modal-title-vcenter">
            Add New Aircraft Maintenance Organization
          </Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <Formik
            ...
            onSubmit={(values) => {
              dispatch(addAircraftMaintenanceOrgAsync(values))
                .then((response) => {
                  if (response.payload) {
                    props.onHide();
                  }
